    ...
    <>
      <section className="pt-2 md:pt-3 pb-4 md:pb-6" style={{ backgroundColor: '#1b1c2f' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="rounded-lg shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-white/10 cursor-pointer" style={{ backgroundColor: '#1b1c2f' }} onClick={() => setIsModalOpen(true)}>
